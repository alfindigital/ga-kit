...
import { ArrowLeft, History, Link2, QrCode, Youtube, Star, BarChart3 } from 'lucide-react';
...
export default function UrlHistory() {
  ...
  const handleLoadUrl = (item: UrlHistoryItem) => {
    // Navigate to the appropriate tool with the URL
    switch (item.toolType) {
      case 'utm':
        // For UTM, we navigate with the base URL and let user rebuild
      ...
      case 'qr':
        ...
        break;
      case 'yt-finder':
        // YT Finder stores URLs in the url field
        navigate('/yt-finder');
        // Store in sessionStorage for YT Finder to pick up
